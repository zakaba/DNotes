...
static const int64 MIN_TX_FEE = 0.05 * COIN;
...
// KGW fix, block reward fix, subsidy reduction fix
static const unsigned int FORK_HEIGHT = 150000;
static const unsigned int FORK_TIME = 1402503443;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1150 / 250; // DNotes: 1150 blocks found a day. Priority cutoff is 1 DNotes day / 250 bytes.
    }
...
public:
    ...
    int64 GetMedianTimePast() const
    {
        ...
        int span = ((pindex->nHeight > FORK_HEIGHT) ? nKGWMedianTimeSpan : nMedianTimeSpan);
